...
OPERATION_LABELS = {
    ...
    ("roleplay", "realtime"): "롤플레잉 음성 대화",
    ("roleplay", "realtime_transcription"): "롤플레잉 음성 인식",
    ("roleplay", "realtime_transcription_error"): "롤플레잉 음성 인식 실패",
    ("roleplay", "realtime_error"): "롤플레잉 음성 오류",
    ("roleplay", "realtime_connection"): "롤플레잉 음성 연결 오류",
