...
OPENAPI_TAGS = [
    ...
    {"name": "users", "description": "FastAPI-Users가 제공하는 사용자 기본 관리 API입니다."},
    ...
    {"name": "quiz", "description": "단어장 기반 퀴즈 생성, 채점, 복습 스케줄, 통계 API입니다."},
    {"name": "roleplay", "description": "AI 롤플레잉 대화, 코칭, 정리, 학습노트 API입니다."},
    {"name": "slang", "description": "AI가 단어의 뉘앙스와 슬랭 용법을 설명하는 API입니다."},
    {"name": "articles", "description": "뉴스 리딩 학습과 기사 세션 관리 API입니다."},
    {"name": "agent", "description": "앱 사용을 돕는 AI 학습 에이전트 API입니다."},
...
app = FastAPI(
    ...
    description="영어 학습 앱 프론트엔드에서 사용하는 FastAPI REST API입니다.",
